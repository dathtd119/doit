...
Learn how to install, configure, and extend Doit, the terminal-based AI coding assistant (forked from Grok Build).
...
Automate, script, and integrate Doit with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `doit -p`, output formats, CI/CD integration, and piping |
