...
| Do | Do not |
|----|--------|
| Map `do-harness/config.models.yaml` → stock TOML + agent frontmatter | Replace `~/.config/doit/config.toml` multi-model registry with a second runtime source of truth |
